...
@ -I ../include -I ./include -I ../arch/arm/include/uapi -I ../include/uapi
@ -I ./include/generated/uapi -I ../. -I . -imultilib sf
@ -imultiarch arm-linux-gnueabi -D __KERNEL__ -D __LINUX_ARM_ARCH__=7
@ -U arm -D CC_HAVE_ASM_GOTO -D KBUILD_BASENAME="asm_offsets"
