...
__attribute__((section("__versions"))) = {
	...
	{ 0xa8f41ddc, __VMLINUX_SYMBOL_STR(lcdpi_touchparams) },
...
MODULE_ALIAS("of:N*T*Cmicrochip,ar10204d");
MODULE_ALIAS("of:N*T*Cmicrochip,ar10204dC*");

MODULE_INFO(srcversion, "B8400F3C139CCEC24F47637");
